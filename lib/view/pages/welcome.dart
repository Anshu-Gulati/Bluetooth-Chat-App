                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Fade(
                      1.3,
                      Text(
                        'BT-Chat! is an cross platform-based chat application prototype which I built using Flutter and Nearby Connections API plugin.\nUnlike most chat applications, It utilizes Bluetooth, Wi-Fi, and Location Services in mobile phones to create a fully-offline peer-to-peer network.\nThis app allows users to easily discover, connect to, and exchange data with nearby devices in real-time, regardless of network connectivity.',
                        style: TextStyle(
